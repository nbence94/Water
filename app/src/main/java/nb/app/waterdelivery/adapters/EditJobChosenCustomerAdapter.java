...
public class EditJobChosenCustomerAdapter extends RecyclerView.Adapter<EditJobChosenCustomerAdapter.ViewHolder> implements EditJobOnDialogChoice {
    ...
    //Gyerek recycler
    EditJobChosenCustomerWatersAdapter adapter;
    int customer_cost;
    ...
    public EditJobChosenCustomerAdapter(Context context, Activity activity, ArrayList<Customers> customers_data, ArrayList<Waters> water_list, ArrayList<JawDraft> draft_list, int jobid) {
    ...
    @NonNull
    @Override
    public EditJobChosenCustomerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.custom_chosen_customer_layout, parent, false);
        return new EditJobChosenCustomerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EditJobChosenCustomerAdapter.ViewHolder holder, int position) {
        ...
        holder.add_water.setOnClickListener(v -> {
            ...
            mad.editJobMultiSelect("Válassz vizet", waters_name_to_show, chosen_waters_boolean, tmp_chosen_waters_boolean, "Rendben", "Mégse", holder, position,this);
        });
    ...
    private void loadElements(@NonNull EditJobChosenCustomerAdapter.ViewHolder holder, ArrayList<JawDraft> draft_list) {
        adapter = new EditJobChosenCustomerWatersAdapter(context, activity, waters_list, draft_list);
    ...
    public void calculateCostForWater(@NonNull EditJobChosenCustomerAdapter.ViewHolder holder, int position) {
        customer_cost = 0;
