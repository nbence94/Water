...
public class EditMyJobActivity extends AppCompatActivity implements EditJobOnDialogChoice, OnDialogTextChange {

    private final String LOG_TITLE = "EditMyJobActivity";
    ...
    EditJobChosenCustomerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dh.getCustomersData(
                "SELECT * " +
                        ...
                        "AND c.UserID = " + sld.loadUserID() +" AND c.ID NOT IN ( SELECT c.ID " +
    ...
    public void showCustomersInRecyclerView() {
        ...
        adapter = new EditJobChosenCustomerAdapter(this, this, chosen_customers_list, all_water_list, draft_list, job_id);
